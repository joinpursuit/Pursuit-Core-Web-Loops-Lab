...
function evenAndOddWhileLoop(max) {
  ...
  while (i <= max) {
    if (i % 2 === 0) {
      array2.push(i + " is even")
      i++
    }
    else {
      array2.push(i + " is odd")
      i++
    }
  }
  return array2
 ...
 * The loop is going to be infinite because i is initially 5 and is increasing so it will never be under 3
 */
