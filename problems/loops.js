 ...
 *this is an infinite loop since i is already greater than 3 so it will keep adding 1 to the last result. 
 */ 
...
function cumulativeSum(elements) {
  if(elements.length === 0) //didn't expect an empty array
    return elements
