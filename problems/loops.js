 ...
 * The loop is going to be infinite because i is initially 5 and is increasing and will never be less than 3
 */
...
function containsForLoop(elements, target) {
  // return arr.firstIndexOf(target)
