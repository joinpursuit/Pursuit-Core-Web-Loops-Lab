...
for(let init = 99, consis = 1; init > 0; init--){
    ...
    if(init > 2){
        ...
        console.log(init + ' bottles of beer on the wall,' + init + ' bottle of beer. Take one down, pass it around,' + sol + ' bottle of beer on the wall.');
      } else {
        console.log(init + ' bottle of beer on the wall,' + init + ' bottle of beer. Take one down, pass it around,' + sol + ' bottle of beer on the wall.');
